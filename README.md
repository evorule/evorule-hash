...
>
> **当前版本**: v0.1.2（CR-20260826-001）。evorule-bundle / evorule-rule 直接依赖本仓；
...
**Apache-2.0**（自 v0.1.3 起）。历史版本 v0.1.0–v0.1.2 曾以 AGPL-3.0-or-later 发布，已发布版本不可撤回。本 crate 为独立实现，非任何 AGPL 代码的衍生。详见 [LICENSE](LICENSE) 与 [NOTICE.md](NOTICE.md)。
